...
list_levels = [3]  # Two levels: first level with 4 vertices, second level with 3 vertices

# Define distance information
distance_info = DistanceInfo(
    distance=[3],  # Distances for each level
    distance_type=["edge"]
)
...
path_figure_file = os.path.join(path_figures, "demo_three_clusters.png")
...
path_figure_file_no_data = os.path.join(path_figures, "demo_three_clusters_no_data.png")
